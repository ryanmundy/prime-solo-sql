...
INSERT INTO accounts (username, city, transactions_completed, transactions_attempted, account_balance) VALUES ('Ryan', 'Minneapolis', 6, 20, 200.00);
...
WHERE "city" ILIKE 'Miami' OR "city" ILIKE 'Phoenix' AND
